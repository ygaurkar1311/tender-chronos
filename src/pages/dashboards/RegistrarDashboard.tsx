...
const RegistrarDashboard = () => {
  ...
  const pendingTenders = tenders.filter(t => t.status === 'pending_approval' && !t.approvals.registrar);
  const approvedCount = tenders.filter(t => t.approvals.registrar).length;
