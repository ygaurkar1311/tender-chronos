...
const DirectorDashboard = () => {
  ...
  const pendingTenders = tenders.filter(
    ...
    (t.approvals.director === false || typeof t.approvals.director === 'boolean')
  );
  const approvedCount = tenders.filter(t => t.approvals.director && typeof t.approvals.director !== 'boolean').length;
  ...
  const handleApprovalConfirm = async (approvalData: ApprovalData) => {
    ...
    try {
      if (approvalAction === 'approve') {
        await api.approveTender(selectedTender.id, 'director', {
          ...approvalData,
        ...
        await api.rejectTender(selectedTender.id, 'director', {
